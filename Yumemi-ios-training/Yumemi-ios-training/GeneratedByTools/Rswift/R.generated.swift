    ...
    struct main: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if #available(iOS 11.0, tvOS 11.0, *) {
          ...
          if UIKit.UIColor(named: "Red", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Color named 'Red' is used in storyboard 'Main', but couldn't be loaded.") }
        }
      }
